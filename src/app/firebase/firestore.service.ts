...
export class FirestoreService {
  ...
  // leer varios documentos a la vez, leer documentos en tiempo real
  ...
  // Permite hacer muchas consultas con varios querys, nos permite hacer consultas a la base de datos de cualquier tipo
  ...
  // hacemos la consulta con un solo query
